...
if (isset($_POST['logout'])) {
    ...
    header("Location: https://eco-ride.online/public/login.php"); // Redirige vers la page login
    exit();
}
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/" aria-label="Apprennez en plus sur notre site de covoiturage ">Home</a>
                </li>
                <li class="nav-item">
        ...
        <div class=" hero-scene-content " id="sectionRecherche">
            <form action="" method="post">
                <div class="recherche-multicriteres text-black">
                    ...
                    <input type="text" id="arrivee" name="arrivee" placeholder="Arrivée">
